...
!(function ($) {
  ...
  */
  ...
  //  festival customize
  var start_time = 1565107200, // toolbar 特殊样式起始时间戳new Date(2018,11,29).getTime()/1000
    end_time = 1565193600,  // toolbar 特殊样式结束时间戳
  ...
  // }
  if (now_time > start_time && now_time < end_time) {
    logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/csdn-qq.jpg">';
    logo_title = '七夕节';
  }
  ...
  if (currenturl.indexOf('//bbs.csdn.net') != -1) {
    $.ajax({
      type: "get",
      url: "https://redisdatarecall.csdn.net/redisData/baiduLandingWord?url=" + currenturl + "&size=1",
      dataType: "json",
      success: function (data) {
        if (data.status === 200 && data.content && data.content.length != 0) {
          $('.input_search').val(data.content[0])
        }
      },
      error: function (err) {
        console.log(err)
        ...
        <div class="container row center-block ">\
          ...
          <div class="pull-right login-wrap '+ loginMark + '">\
            <ul class="btns">\
              ...
              <li class="write-bolg-btn" data-report-click=\'{"mod":"popu_370","pid":"toolbar","dest":"https://mp.csdn.net/postedit"}\' data-report-view=\'{"mod":"popu_370","pid":"toolbar","dest":"https://mp.csdn.net/postedit"}\'><a class="" href="//mp.csdn.net/postedit" target="_blank" id="blogClick"><svg class="toolbar-icon" aria-hidden="true"><use xlink:href="#xieboke1"></use></svg><span>写博客</span></a>\
  ...
  $('#csdn-toolbar .logout').click(function () {
    ...
    csdn.report.reportClick(trackdata);
