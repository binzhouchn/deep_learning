...
config = {
    'raw_data_path': BASE_DIR / 'dataset/train_zx.csv',
    ...
    'macbert_vocab_path': BASE_DIR / 'pretrain/macbert-chinese/vocab.txt',
    'macbert_config_file': BASE_DIR / 'pretrain/macbert-chinese/config.json',
    'macbert_model_dir': BASE_DIR / 'pretrain/macbert-chinese',
